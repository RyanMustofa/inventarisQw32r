	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbar">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					<a href="/inventaris/#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-file-text-o"></i> Aset<b class="caret"></b></a>
					<ul class="dropdown-menu">
				<li><a href="/inventaris/aset.php"><i class="fa fa-file-text-o"></i> Pemeliharaan Aset</a></li>
						<li><a href="/inventaris/barang-masuk.php"><i class="fa fa-plus"></i> Barang Masuk</a></li>
						<li><a href="/inventaris/penghapusan.php"><i class="fa fa-line-chart"></i> Penghapusan</a></li>
						<li><a href="/inventaris/hibah.php"><i class="fa fa-exchange"></i> Penghibahan</a></li>
					</ul>
				</li>
				<?php endif; ?>
			</ul>
