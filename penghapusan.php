...
if ($isadmin) {
    ...
    if (isset($_POST['yes'])) {
        ...
        $kirim = $konfigurasi->insertPenghapusan(
            $nama_barang,
            $spesifikasi,
            $jumlah,
            $kondisi,
		  ...
		  <?php include 'include/heading.php'; ?>
			...
			<div class="panel panel-success" id="formInput" hidden>
			  ...
			  <div class="panel-body">
					<form class="" action="penghapusan.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
       ...
       echo "<hr><h2 class='text-center'>Tidak ada data</h2><hr>";
        ...
        ?>
			...
			<tr>
                ...
                <td><img class="img-fluid" height="100" width="100" src="upload-image/penghapusan/<?php echo $data['image']; ?>" alt="image" style="border-radius: 10px"></td>
				<?php if ($isadmin): ?>
					<td>
						<a href="detail/detail-penghapusan.php?rowid=<?php echo $data[
          'id'
      ]; ?>"><i class="fa fa-eye"></i></a> |
                        <a href="hapus/hapus-penghapusan.php?rowid=<?php echo $data[
                            'id'
