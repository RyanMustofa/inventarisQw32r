...
$count4 = $q4->num_rows;
$q5 = $konfigurasi->select(
    "peminjaman",
    "status_peminjaman",
    "belum dikembalikan"
);
$count5 = $q5->num_rows;
$q6 = $konfigurasi->select(
    "peminjaman",
    "status_peminjaman",
    "telah dikembalikan"
);
$count6 = $q6->num_rows;
$q7 = $konfigurasi->select("pemeliharaan_aset", "", "");
$count7 = $q7->num_rows;
$q8 = $konfigurasi->select("barang_masuk","","");
$count8 = $q8->num_rows;
$q9 = $konfigurasi->select("penghapusan","","");
$count9 = $q9->num_rows;
$q10 = $konfigurasi->select("penghibahan","","");
$count10 = $q10->num_rows;
?>
<!DOCTYPE html>
<html lang="en">
  <head>
			...
			<div class="container">
				...
				<div class="panel panel-info">
				  <div class="panel-body bg-default">
						...
						<h1 style="text-transform: capitalize;">selamat datang <?php echo $_SESSION[
          'nama_petugas'
      ]; ?></h1>

						<h3>Anda login sebagai <strong class="text-capitalize"><?php echo $_SESSION[
          'level'
      ]; ?>.</strong>
    ...
    <div class="row" style="margin-top: 2rem!important;">
        <div class="col-sm-4">
          <div class="panel-body bg-purple">
            <div class="col-md-offset-0">
              <div class=" col-md-offset-0" style="margin-top:0px;">
  						<h3>	<span><i class="fa fa-file-text-o fa-1x"></i></span> Total Jumlah Pemeliharaan</h3>
                <h4><?php echo $count7; ?> Aset</h4>
  						</div>
            </div>
        </div>
        </div>
        <div class="col-sm-4">
          <div class="panel-body bg-purple">
            <div class="col-md-offset-0">
              <div class=" col-md-offset-0" style="margin-top:0px;">
  						<h3>	<span><i class="fa fa-file-text-o fa-1x"></i></span> Total Barang Masuk</h3>
                <h4><?php echo $count8; ?> Barang</h4>
  						</div>
            </div>
        </div>
        </div>
        <div class="col-sm-4">
          <div class="panel-body bg-purple">
            <div class="col-md-offset-0">
              <div class=" col-md-offset-0" style="margin-top:0px;">
  						<h3>	<span><i class="fa fa-file-text-o fa-1x"></i></span> Total penghapusan</h3>
                <h4><?php echo $count9; ?> Barang</h4>
  						</div>
            </div>
        </div>
        </div>
