...
$id = $_GET['rowid'];
$detail = $konfigurasi->detailBarangMasuk($id);
...
if (isset($_POST['updateyes'])) {
    ...
    $insert = $konfigurasi->updateBarangMasuk($kode_inventaris,$nama_barang,$spesifikasi,$jumlah,$kondisi,$status,$id,$fotoBaru);
    if ($insert) {
		...
		<div class="container">
		  <?php include '../include/heading.php'; ?>
			...
			<div class="panel panel-success">
			  <div class="panel-heading">
			    <h3 class="panel-title"><i class="fa fa-edit"></i> Update Barang Masuk</h3>
			  </div>
          ...
          <button type="button" id="btnedit" onclick="editInventaris()" class="btn btn-success"><i class="fa fa-edit"></i> Edit</button>
  				<button type="button" class="btn btn-primary" id="btnupdate"  style="float:left;margin-right:5px;" data-toggle="modal" data-target="#konfirmupdate"><i class="fa fa-check"></i> Simpan</button>
  					<a href="/inventaris/barang-masuk.php" class="btn btn-danger"><i class="fa fa-forward"></i> Kembali</a>
