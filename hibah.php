		  ...
		  <?php include 'include/heading.php'; ?>
			<div class="form-group">
				<button type="button" class="btn btn-default" id="btnPlus">
				  <i class="fa fa-plus"></i> Tambah Hibah
				</button>
			...
			<div class="panel panel-success" id="formInput" hidden>
			  ...
			  <div class="panel-body">
					<form class="" action="hibah.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
       ...
       echo "<hr><h2 class='text-center'>Tidak ada data</h2><hr>";
        ...
        ?>
			...
			<tr>
                ...
                <td><img class="img-fluid" height="100" width="100" src="upload-image/hibah/<?php echo $data['image']; ?>" alt="image" style="border-radius: 10px"></td>
				<?php if ($isadmin): ?>
					<td>
						<a href="detail/detail-hibah.php?rowid=<?php echo $data[
          'id'
      ]; ?>"><i class="fa fa-eye"></i></a> |
                        <a href="hapus/hapus-hibah.php?rowid=<?php echo $data[
                            'id'
